  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested image" do
        ...
        Image.any_instance.should_receive(:update).with({ "url" => "MyString" })
        put :update, {:id => image.to_param, :image => { "url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the image as @image" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Image.any_instance.stub(:save).and_return(false)
        put :update, {:id => image.to_param, :image => { "url" => "invalid value" }}, valid_session
        assigns(:image).should eq(image)
      end
